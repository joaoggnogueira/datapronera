...
class Relatorio_geral extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('relatorio_geral_m');     // Loading Model
    ...
    public function index() {
        ...
        if ($this->session->userdata('access_level') > 3) {
            $this->session->set_userdata('curr_content', 'rel_geral_nacional');

        // Pesquisadores Estaduais e Auxiliares de Pesquisa
        } else if ($this->session->userdata('access_level') > 1) {
            $this->session->set_userdata('curr_content', 'rel_geral_estadual');
        }
    ...
    public function cursos_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->cursos_modalidade($this->session->userdata('access_level'))) {
    ...
    public function cursos_nivel() {
        ...
        if ($result = $this->relatorio_geral_m->cursos_nivel($this->session->userdata('access_level'))) {
    ...
    public function cursos_nivel_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m->cursos_nivel_superintendencia($levels)) {
    ...
    public function cursos_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->cursos_superintendencia()) {
    ...
    public function alunos_ingressantes_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_ingressantes_modalidade($this->session->userdata('access_level'))) {
    ...
    public function alunos_ingressantes_nivel() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_ingressantes_nivel($this->session->userdata('access_level'))) {
     ...
     public function alunos_concluintes_nivel_sr() {
        ...
        if ($result = $this->relatorio_geral_m->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m->alunos_concluintes_nivel_sr($levels)) {
    ...
    public function alunos_ingressantes_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_ingressantes_superintendencia()) {
    ...
    public function alunos_concluintes_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_concluintes_modalidade($this->session->userdata('access_level'))) {
    ...
    public function alunos_concluintes_nivel() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_concluintes_nivel($this->session->userdata('access_level'))) {
    ...
    public function alunos_concluintes_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->alunos_concluintes_superintendencia()) {
    ...
    public function municipios_curso_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->municipios_curso_modalidade($this->session->userdata('access_level'))) {
    ...
    public function municipios_curso() {
        ...
        if ($result = $this->relatorio_geral_m->municipios_curso($this->session->userdata('access_level'))) {
    ...
    public function lista_cursos_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->lista_cursos_modalidade($this->session->userdata('access_level'))) {
    ...
    public function titulacao_educadores() {
        ...
        if ($result = $this->relatorio_geral_m->titulacao_educadores($this->session->userdata('access_level'))) {
    ...
    public function titulacao_educadores_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->titulacao_educadores_superintendencia()) {
    ...
    public function educadores_nivel() {
        ...
        if ($result = $this->relatorio_geral_m->educadores_nivel($this->session->userdata('access_level'))) {
    ...
    public function educadores_curso() {
        ...
        if ($result = $this->relatorio_geral_m->educadores_curso($this->session->userdata('access_level'))) {
    ...
    public function educadores_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->educadores_superintendencia()) {
    ...
    public function genero_educadores_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->genero_educadores_modalidade($this->session->userdata('access_level'))) {
    ...
    public function educandos_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->educandos_superintendencia()) {
    ...
    public function municipio_origem_educandos() {
        ...
        if ($result = $this->relatorio_geral_m->municipio_origem_educandos($this->session->userdata('access_level'))) {
    ...
    public function territorio_educandos_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->territorio_educandos_modalidade($this->session->userdata('access_level'))) {
    ...
    public function territorio_educandos_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->territorio_educandos_superintendencia()) {
    ...
    public function idade_educandos_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->idade_educandos_modalidade($this->session->userdata('access_level'))) {
    ...
    public function genero_educandos_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->genero_educandos_modalidade($this->session->userdata('access_level'))) {
    ...
    public function localizacao_instituicoes_ensino() {
        ...
        if ($result = $this->relatorio_geral_m->localizacao_instituicoes_ensino($this->session->userdata('access_level'))) {
    ...
    public function instituicoes_ensino_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->instituicoes_ensino_modalidade($this->session->userdata('access_level'))) {
    ...
    public function instituicoes_ensino_nivel() {
        ...
        if ($result = $this->relatorio_geral_m->instituicoes_ensino_nivel($this->session->userdata('access_level'))) {
    ...
    public function instituicoes_ensino_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->instituicoes_ensino_superintendencia()) {
    ...
    public function instituicoes_ensino_municipio() {
        ...
        if ($result = $this->relatorio_geral_m->instituicoes_ensino_municipio($this->session->userdata('access_level'))) {
    ...
    public function instituicoes_ensino_estado() {
        ...
        if ($result = $this->relatorio_geral_m->instituicoes_ensino_estado()) {
    ...
    public function cursos_natureza_inst_ensino() {
        ...
        if ($result = $this->relatorio_geral_m->cursos_natureza_inst_ensino($this->session->userdata('access_level'))) {
    ...
    public function instituicao_ensino_cursos() {
        ...
        if ($result = $this->relatorio_geral_m->instituicao_ensino_cursos($this->session->userdata('access_level'))) {
    ...
    public function organizacoes_demandantes_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->organizacoes_demandantes_modalidade($this->session->userdata('access_level'))) {
    ...
    public function membros_org_demandantes_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->membros_org_demandantes_modalidade($this->session->userdata('access_level'))) {
    ...
    public function organizacao_demandante_cursos() {
        ...
        if ($result = $this->relatorio_geral_m->organizacao_demandante_cursos($this->session->userdata('access_level'))) {
    ...
    public function localizacao_parceiros() {
        ...
        if ($result = $this->relatorio_geral_m->localizacao_parceiros($this->session->userdata('access_level'))) {
    ...
    public function parceiros_modalidade() {
        ...
        if ($result = $this->relatorio_geral_m->parceiros_modalidade($this->session->userdata('access_level'))) {
    ...
    public function parceiros_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->parceiros_superintendencia()) {
    ...
    public function parceiros_natureza() {
        ...
        if ($result = $this->relatorio_geral_m->parceiros_natureza($this->session->userdata('access_level'))) {
    ...
    public function lista_parceiros() {
        ...
        if ($result = $this->relatorio_geral_m->lista_parceiros($this->session->userdata('access_level'))) {
    ...
    public function producoes_estado() {
        ...
        if ($result = $this->relatorio_geral_m->producoes_estado()) {
    ...
    public function producoes_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->producoes_superintendencia()) {
    ...
    public function producoes_tipo() {
        ...
        if ($result = $this->relatorio_geral_m->producoes_tipo($this->session->userdata('access_level'))) {
    ...
    public function pesquisa_estado() {
        ...
        if ($result = $this->relatorio_geral_m->pesquisa_estado()) {
     ...
     public function pesquisa_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m->pesquisa_superintendencia()) {
    ...
    public function pesquisa_tipo() {
        ...
        if ($result = $this->relatorio_geral_m->pesquisa_tipo($this->session->userdata('access_level'))) {
