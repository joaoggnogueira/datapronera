...
class Relatorio_geral_concluido extends CI_Controller {
    ...
    public function cursos_nivel_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m_concluido->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_concluido->cursos_nivel_superintendencia($levels)) {
    ...
    public function alunos_ingressantes_nivel_sr() {
        ...
        if ($result = $this->relatorio_geral_m_concluido->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_concluido->alunos_ingressantes_nivel_sr($levels)) {
     ...
     public function alunos_concluintes_nivel_sr() {
        ...
        if ($result = $this->relatorio_geral_m_concluido->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_concluido->alunos_concluintes_nivel_sr($levels)) {
