...
class Relatorio_geral_andamento extends CI_Controller {
    ...
    public function cursos_nivel_superintendencia() {
        ...
        if ($result = $this->relatorio_geral_m_andamento->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_andamento->cursos_nivel_superintendencia($levels)) {
    ...
    public function alunos_ingressantes_nivel_sr() {
        ...
        if ($result = $this->relatorio_geral_m_andamento->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_andamento->alunos_ingressantes_nivel_sr($levels)) {
     ...
     public function alunos_concluintes_nivel_sr() {
        ...
        if ($result = $this->relatorio_geral_m_andamento->get_niveis_modalidade()) {
            ...
            if ($result = $this->relatorio_geral_m_andamento->alunos_concluintes_nivel_sr($levels)) {
