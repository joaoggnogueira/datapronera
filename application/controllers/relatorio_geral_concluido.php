...
class Relatorio_geral_concluido extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('relatorio_geral_m_concluido');     // Loading Model
    ...
    public function index() {
        ...
        if ($this->session->userdata('access_level') > 3) {
            $this->session->set_userdata('curr_content', 'rel_geral_nacional_concluido');

        // Pesquisadores Estaduais e Auxiliares de Pesquisa
        } else if ($this->session->userdata('access_level') > 1) {
            $this->session->set_userdata('curr_content', 'rel_geral_estadual_concluido');
        }
    ...
    public function municipios_curso_modalidade($tipo) {
        if ($result = $this->relatorio_geral_m_concluido->municipios_curso_modalidade($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
            ...
            if($tipo == 2){
                ...
                $header = $this->load->view('relatorio/concluido/header_pdf', $data, true); 
    ...
    public function municipios_curso($tipo) {//???
        ...
        if ($result = $this->relatorio_geral_m_concluido->municipios_curso($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function cursos_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->cursos_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function cursos_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->cursos_nivel($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function cursos_nivel_superintendencia($tipo) {
        if ($result = $this->relatorio_geral_m_concluido->cursos_nivel_superintendencia()) {
            if($tipo==1){
                $titles = array();
                $titles[0] = "CÓDIGO";
    ...
    public function cursos_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->cursos_superintendencia()) {
            if($tipo == 1){
                $xls = array();
    ...
    public function alunos_ingressantes_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_ingressantes_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_ingressantes_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_ingressantes_nivel($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_ingressantes_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_ingressantes_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_ingressantes_nivel_sr($tipo) {
        if ($result = $this->relatorio_geral_m_concluido->alunos_ingressantes_nivel_sr()) {
            if($tipo==1){
                $titles = array();
                $titles[0] = "CÓDIGO";
                $titles[1] = "SUPERINTENDÊNCIA";
    ...
    public function alunos_concluintes_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_concluintes_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_concluintes_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_concluintes_nivel($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_concluintes_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_concluintes_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function alunos_concluintes_nivel_sr($tipo) {
        if ($result = $this->relatorio_geral_m_concluido->alunos_concluintes_nivel_sr()) {
            if($tipo==1){
                $titles = array();
                $titles[0] = "CÓDIGO";
                $titles[1] = "SUPERINTENDÊNCIA";
    ...
    public function lista_cursos_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->lista_cursos_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function lista_cursos_modalidade_sr($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->lista_cursos_modalidade_sr($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
                $xls = $this->create_header("Lista de cursos por modalidade", 1);
    ...
    public function alunos_curso($tipo){
        ...
        if ($result = $this->relatorio_geral_m_concluido->alunos_curso()) {
            if($tipo==1){
                $xls = array();
    ...
    public function titulacao_educadores($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->titulacao_educadores($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function titulacao_educadores_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->titulacao_educadores_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function educadores_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->educadores_nivel($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function educadores_curso($tipo) {//??
        ...
        if ($result = $this->relatorio_geral_m_concluido->educadores_curso($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function educadores_superintendencia($tipo) {//?
        ...
        if ($result = $this->relatorio_geral_m_concluido->educadores_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function genero_educadores_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->genero_educadores_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function educandos_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->educandos_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function municipio_origem_educandos($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->municipio_origem_educandos($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function territorio_educandos_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->territorio_educandos_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function territorio_educandos_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->territorio_educandos_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function idade_educandos_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->idade_educandos_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function genero_educandos_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->genero_educandos_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function educandos_assentamento_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->educandos_assentamento_modalidade()) {
            if($tipo==1){
                $xls = array();
    ...
    public function educandos_assentamento_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->educandos_assentamento_nivel()) {
            if($tipo==1){
                $xls = array();
    ...
    //não funcional
    public function lista_educandos_cursos_sr($tipo) {

        // GAMBIARRRA para aumentar a área de memória 
        ini_set('memory_limit', '1024M');

        if ($result = $this->relatorio_geral_m_concluido->lista_educandos_cursos_sr()) {
            if($tipo==1){
                $xls = array();
    ...
    public function localizacao_instituicoes_ensino($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->localizacao_instituicoes_ensino($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function instituicoes_ensino_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicoes_ensino_modalidade($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function instituicoes_ensino_nivel($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicoes_ensino_nivel($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function instituicoes_ensino_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicoes_ensino_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function instituicoes_ensino_municipio($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicoes_ensino_municipio($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function instituicoes_ensino_estado($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicoes_ensino_estado()) {
            if($tipo == 1){
                $xls = array();
    ...
    public function cursos_natureza_inst_ensino($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->cursos_natureza_inst_ensino($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function instituicao_ensino_cursos($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->instituicao_ensino_cursos($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function organizacoes_demandantes_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->organizacoes_demandantes_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function membros_org_demandantes_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->membros_org_demandantes_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function organizacao_demandante_cursos($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->organizacao_demandante_cursos($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function localizacao_parceiros($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->localizacao_parceiros($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function parceiros_modalidade($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->parceiros_modalidade($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function parceiros_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->parceiros_superintendencia()) {
            if($tipo==1){
                $xls = array();
    ...
    public function parceiros_natureza($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->parceiros_natureza($this->session->userdata('access_level'))) {
            if($tipo == 1){
                $xls = array();
    ...
    public function lista_parceiros($tipo) {
        if ($result = $this->relatorio_geral_m_concluido->lista_parceiros($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function producoes_estado($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->producoes_estado()) {
            if($tipo==1){
                $xls = array();
    ...
    public function producoes_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->producoes_superintendencia()) {
            if($tipo==1){
                $xls = array();
                $xls = $this->create_header("Produções por tipo de produção", 1);
    ...
    public function producoes_tipo($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->producoes_tipo($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
    ...
    public function pesquisa_estado($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->pesquisa_estado()) {
            if($tipo==1){
                $xls = array();
                $xls = $this->create_header("Produções por tipo de produção", 1);
    ...
    public function pesquisa_superintendencia($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->pesquisa_superintendencia()) {
            if($tipo==1){
                $xls = array();
                $xls = $this->create_header("Produções por tipo de produção", 1);
    ...
    public function pesquisa_tipo($tipo) {
        ...
        if ($result = $this->relatorio_geral_m_concluido->pesquisa_tipo($this->session->userdata('access_level'))) {
            if($tipo==1){
                $xls = array();
                $xls = $this->create_header("Produções por tipo de produção", 2);
                $titles = array("TIPO", "PRODUÇÕES");
