...
class Relatorio_geral_concluido extends CI_Controller {
    ...
    public function municipios_curso_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->municipios_curso_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
    ...
    public function municipios_curso($tipo) {//???
        $result = $this->relatorio_geral_m_concluido->municipios_curso($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function cursos_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->cursos_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function cursos_nivel($tipo) {
        $result = $this->relatorio_geral_m_concluido->cursos_nivel($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function cursos_nivel_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->cursos_nivel_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function cursos_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->cursos_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_ingressantes_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_ingressantes_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_ingressantes_nivel($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_ingressantes_nivel($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_ingressantes_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_ingressantes_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_ingressantes_nivel_sr($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_ingressantes_nivel_sr();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_concluintes_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_concluintes_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_concluintes_nivel($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_concluintes_nivel($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_concluintes_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_concluintes_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_concluintes_nivel_sr($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_concluintes_nivel_sr();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function lista_cursos_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->lista_cursos_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function lista_cursos_modalidade_sr($tipo) {
        $result = $this->relatorio_geral_m_concluido->lista_cursos_modalidade_sr($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function alunos_curso($tipo) {
        $result = $this->relatorio_geral_m_concluido->alunos_curso();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function titulacao_educadores($tipo) {
        $result = $this->relatorio_geral_m_concluido->titulacao_educadores($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function titulacao_educadores_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->titulacao_educadores_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function educadores_nivel($tipo) {
        $result = $this->relatorio_geral_m_concluido->educadores_nivel($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function educadores_curso($tipo) {//??
        $result = $this->relatorio_geral_m_concluido->educadores_curso($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function educadores_superintendencia($tipo) {//?
        $result = $this->relatorio_geral_m_concluido->educadores_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function genero_educadores_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->genero_educadores_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function educandos_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->educandos_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function municipio_origem_educandos($tipo) {
        $result = $this->relatorio_geral_m_concluido->municipio_origem_educandos($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function territorio_educandos_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->territorio_educandos_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function territorio_educandos_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->territorio_educandos_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function idade_educandos_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->idade_educandos_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function genero_educandos_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->genero_educandos_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function educandos_assentamento_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->educandos_assentamento_modalidade();
    ...
    public function educandos_assentamento_nivel($tipo) {
        ...
        $result = $this->relatorio_geral_m_concluido->educandos_assentamento_nivel();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function lista_educandos_cursos_sr($tipo) {
        ...
        // GAMBIARRRA para aumentar a área de memória 
        ini_set('memory_limit', '1024M');
        $result = $this->relatorio_geral_m_concluido->lista_educandos_cursos_sr();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function localizacao_instituicoes_ensino($tipo) {
        $result = $this->relatorio_geral_m_concluido->localizacao_instituicoes_ensino($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicoes_ensino_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicoes_ensino_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicoes_ensino_nivel($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicoes_ensino_nivel($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicoes_ensino_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicoes_ensino_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicoes_ensino_municipio($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicoes_ensino_municipio($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicoes_ensino_estado($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicoes_ensino_estado();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function cursos_natureza_inst_ensino($tipo) {
        $result = $this->relatorio_geral_m_concluido->cursos_natureza_inst_ensino($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function instituicao_ensino_cursos($tipo) {
        $result = $this->relatorio_geral_m_concluido->instituicao_ensino_cursos($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function organizacoes_demandantes_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->organizacoes_demandantes_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function membros_org_demandantes_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->membros_org_demandantes_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function organizacao_demandante_cursos($tipo) {
        $result = $this->relatorio_geral_m_concluido->organizacao_demandante_cursos($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function localizacao_parceiros($tipo) {
        $result = $this->relatorio_geral_m_concluido->localizacao_parceiros($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function parceiros_modalidade($tipo) {
        $result = $this->relatorio_geral_m_concluido->parceiros_modalidade($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function parceiros_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->parceiros_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function parceiros_natureza($tipo) {
        $result = $this->relatorio_geral_m_concluido->parceiros_natureza($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function lista_parceiros($tipo) {
        $result = $this->relatorio_geral_m_concluido->lista_parceiros($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function producoes_estado($tipo) {
        $result = $this->relatorio_geral_m_concluido->producoes_estado();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function producoes_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->producoes_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function producoes_tipo($tipo) {
        $result = $this->relatorio_geral_m_concluido->producoes_tipo($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function pesquisa_estado($tipo) {
        $result = $this->relatorio_geral_m_concluido->pesquisa_estado();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function pesquisa_superintendencia($tipo) {
        $result = $this->relatorio_geral_m_concluido->pesquisa_superintendencia();
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
    ...
    public function pesquisa_tipo($tipo) {
        $result = $this->relatorio_geral_m_concluido->pesquisa_tipo($this->session->userdata('access_level'));
        if (is_array($result)) {
            if (empty($result)) {
                echo "Não existem registros para serem exibidos neste relatório!";
                return;
