 	...
 	$(document).ready(function() {
        ...
        $('#salvar').click(function () {
        	...
        	if (isFormComplete(form)) {
	            ...
	            var urlRequest = "<?php if ($operacao == 'add') echo site_url('pessoa/add/'); else if ($operacao == 'update') echo site_url('pessoa/update'); ?>";
  	...
  	<fieldset>
		...
		<div class="form-group">
	    	...
	    	<div class="form-group interno">
			    ...
			    <div class="form-group">
			    	<div>
			    		<input type="text" class="form-control tamanho-smaller" id="numero" name="numero" onkeypress="return preventChar();" maxlength="6"
