...
<script type="text/javascript">
	...
	//recupera estados e municipios selecionando oque está no banco de dados
 	...
 	$(document).ready(function() {
		...
		$('#ckparceiro_tipo_04').optionCheck({
        ...
        $('#salvar').click(function () {
        	...
        	var form = Array(
				...
				{
        			'id'      : 'parceiro_tipo_outros',
        			'ni'	  : !$('#ckparceiro_tipo_04').prop('checked'),
        	...
        	if (isFormComplete(form)) {
	            ...
	            var urlRequest = "<?php if ($operacao == 'add') echo site_url('parceiro/add/'); if ($operacao == 'update') echo site_url('parceiro/update/'); ?>";
	...
	<fieldset>		
		...
		<div class="form-group">
			...
			<div class="checkbox"> 
		      	...
		      	<div class="checkbox"><label> <input type="checkbox" name="ckparceiro_tipo" id="ckparceiro_tipo_04" value="OUTROS" <?php if ($retrivial && $dados[0]->outros == 1) echo "checked" ?>> 
		      		Outros </label></div>
		      		<div>
