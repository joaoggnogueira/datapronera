<script type="text/javascript">    
    ...
    $(document).ready(function() {
        ...
        var table = new Table({
            url      : "<?php echo site_url('request/get_parceiro'); ?>",
            table    : $('#partner_table'),
            controls : $('#partner_controls')
        });

        table.hideColumns([0]);

        //$('#partner_table').tableInit(url);
        //$('#partner_table').hideColumns([0]);
        
        /* Init the table 
        oTable = $('#partner_table').dataTable( {
                "bProcessing": true,
                "sPaginationType": "bootstrap",
                "sAjaxSource": url  + "/request/get_parceiro/"
            } );


        /* Add a click handler to select the rows 
        $("#partner_table tbody").click(function(event) {
        ...
        //TABLE CONTROLS
            ...
            $('#inserir').click(function () {
                ...
                var urlRequest = "<?php echo site_url('parceiro/index_add/'); ?>";
            ...
            $('#alterar').click(function () { 
                ...
                var urlRequest = "<?php echo site_url('parceiro/index_update/'); ?>";
            ...
            $('#remover').click(function () {
                $('#dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('parceiro/remove/'); ?>";
...
<div id="grid">
    <ul id="partner_controls" class="nav nav-pills buttons">        
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="partner_table">
        <thead>
            <tr>
                <th width= "10px" > CÓDIGO </th>
                <th width= "400px"> PARCEIRO </th>
                <th width= "230px"> SIGLA </th>
                <th width= "200px"> MUNICÍPIO </th>
