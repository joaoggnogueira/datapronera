<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        ...
        var tableRunning = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_artigo/AN'); ?>",
            table    : $('#running-table'),
        ...
        //TABLE CONTROLS
            ...
            $('#running-add').click(function () {
                ...
                var urlRequest = "<?php echo site_url('producao9d/index_add'); ?>";
            ...
            $('#running-update').click(function () { 
                ...
                var formData = {
                   id_producao9d :  codigo,
                   operacao : 'update'
                };

                var urlRequest = "<?php echo site_url('producao9d/index_update'); ?>";
            ...
            $('#running-delete').click(function () {  
                ...
                $('#running-dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('producao9d/remove/'); ?>";
        ...
        var tableIIPnera = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_artigo/2P'); ?>",
