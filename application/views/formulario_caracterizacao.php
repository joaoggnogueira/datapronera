...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#ckPrevisto_tempo_comunidade_ni").niCheck({
            'name': ['rprevisto_tempo_comunidade']
        });
        ...
        $('#salvar').click(function () {
            ...
            var form = Array(
                    ...
                    {
                        'name': 'rprevisto_tempo_comunidade',
                        'ni': $('#ckPrevisto_tempo_comunidade_ni').prop('checked'),
                        'message': 'Informe se foi previsto no curso o tempo comunidade',
                        'next': false,
                        'extra': null
                    },
                    {
            ...
            if (isFormComplete(form)) {
                ...
                var formData = {
                    ...
                    ckPrevisto_tempo_comunidade_ni: $('#ckPrevisto_tempo_comunidade_ni').prop('checked'),
                    rPrevisto_tempo_comunidade: $("input:radio[name=rprevisto_tempo_comunidade]:checked").val(),
...
<!--        <div class="form-group">
        ...
        <div class="form-group">
            <label class="negacao">24. Houve algum tipo de avalia&ccedil;&atilde;o do curso (MEC, Conselho Estadual, Colegiado do curso, etc)</label>
        ...
        <div class="form-group">
            <label class="negacao">25. N&uacute;mero de estudantes universit&aacute;rios (bolsistas/monitor/coordenador local/estagi&aacute;rio/t&eacute;cnico de apoio ) </label>
        ...
        <div class="form-group">
            <label class="negacao">25. Foi previsto no curso o tempo comunidade? </label>
            <div class="checkbox negacao-smaller">
                <label> <input type="checkbox" name="ckPrevisto_tempo_comunidade_ni" id="ckPrevisto_tempo_comunidade_ni" value="-1" <?php if ($dados[0]->previsto_tempo_comunidade == "-1") echo "checked"; ?> > N&atilde;o encontrado </label>
            </div>
            <div class="radio form-group">
                <div class="radio"><label> <input type="radio" name="rprevisto_tempo_comunidade" id="rprevisto_tempo_comunidade_01" value="0" <?php if ($dados[0]->previsto_tempo_comunidade == "0") echo "checked"; ?>> N&atilde;o </label></div>
                <div class="radio"><label> <input type="radio" name="rprevisto_tempo_comunidade" id="rprevisto_tempo_comunidade_02" value="1" <?php if ($dados[0]->previsto_tempo_comunidade == "1") echo "checked"; ?>> Sim </label></div>
                <p class="text-danger"><label for="rprevisto_tempo_comunidade"></label></p>
            </div>
        </div>
