...
<form id="form"	method="post">
    <fieldset>
        ...
        <div class="form-group">
            <label><?= ++$countInput; ?>. Abrang&ecirc;ncia da Organiza&ccedil;&atilde;o</label>
            <div class="radio">
        ...
        <div class="form-group">
            <label class="negacao"><?= ++$countInput; ?>. N&uacute;mero de Pessoas do Movimento envolvidas no acompanhamento do Curso</label>
        ...
        <div class="table-box table-box-lg">
            ...
            <?PHP if ($retrivial): ?>
<!--                <div class="form-group interno">
                    <label> Grau de escolaridade na atualidade </label>
                    <div>
                        <input disabled type="text" class="form-control" id="movimento_grau_atual_membro" name="movimento_grau_atual_membro">
        ...
        <div class="form-group">
            <label class="negacao"><?= ++$countInput; ?>. Fonte das informa&ccedil;&otilde;es (nome da pessoa que forneceu os dados)</label>
        ...
        <?PHP if ($retrivial): ?>
            <?PHP if ($dados[0]->data_fundacao_nacional != '01/01/1900'): ?>
                <div class="form-group">
                    <label class="negacao"> Data de Funda&ccedil;&atilde;o Nacional</label>

                    <!--                <div class="checkbox negacao-smaller">
                                        <label> <input disabled type="checkbox" name="ckMovimento_data_naplica" id="ckMovimento_data_naplica" <?php if ($retrivial && $dados[0]->data_fundacao_nacional == '01/01/1900') echo "checked"; ?>> N&atilde;o se aplica </label>
                                    </div>-->

                    <div class="form-group">
                        <div>
                            <input disabled type="text" class="form-control tamanho-sm2" id="movimento_fundacao_nac" name="movimento_fundacao_nac"
                                   value="<?php echo $dados[0]->data_fundacao_nacional; ?>">
                            <label class="control-label form" for="movimento_fundacao_nac"></label>
                        </div>
                    </div>
                </div>
            <?PHP endif; ?>
            <?PHP if ($dados[0]->data_fundacao_estadual != '00/00/0000'): ?>
                <div class="form-group">
                    <label class="negacao"> Data de Funda&ccedil;&atilde;o no Estado</label>
                    ...
                    <div class="form-group">
                        <div>
                            <input disabled type="text" class="form-control tamanho-sm2" id="movimento_fundacao_est" name="movimento_fundacao_est"
            ...
            <?PHP endif; ?>
            <?PHP if ($dados[0]->numero_acampamentos != '-1'): ?>
                <div class="form-group">
                    <label class="negacao"> N&uacute;mero de Acampamentos (estadual)</label>
                    <!--                <div class="checkbox negacao-smaller">
                    ...
                    <div class="form-group">
                        <div>
                            <input disabled type="text" class="form-control tamanho-smaller" id="movimento_num_acamp" name="movimento_num_acamp"  maxLength="6"
                                   value="<?php echo $dados[0]->numero_acampamentos; ?>">
                            <label class="control-label form" for="movimento_num_acamp"></label>
                        </div>
                    </div>
                </div>
            <?PHP endif; ?>
            <?PHP if ($dados[0]->numero_assentamentos != '-1'): ?>
                <div class="form-group">
                    <label class="negacao"> N&uacute;mero de Assentamentos ligados ao Movimento no Estado</label>
                    ...
                    <div class="form-group">
                        <div>
                            <input  disabled type="text" class="form-control tamanho-smaller" id="movimento_num_assent" name="movimento_num_assent"  maxLength="6"
                                    value="<?php echo $dados[0]->numero_assentamentos; ?>">
                            <label class="control-label form" for="movimento_num_assent"></label>
                        </div>
                    </div>
                </div>
            <?PHP endif; ?>
            <?PHP if ($dados[0]->numero_familias_assentadas != '-1'): ?>
                <div class="form-group">
                    <label class="negacao"> N&uacute;mero de Fam&iacute;lias Assentadas</label>

                    <!--                <div class="checkbox negacao-smaller">
                                        <label> <input disabled type="checkbox" name="ckMovimento_num_familia" id="ckMovimento_num_familia" <?php if ($retrivial && $dados[0]->numero_familias_assentadas == '-1') echo "checked"; ?>> N&atilde;o informado </label>
                                    </div>-->

                    <div class="form-group">
                        <div>
                            <input disabled type="text" class="form-control tamanho-smaller" id="movimento_num_familia" name="movimento_num_familia"  maxLength="6"
                                   value="<?php echo $dados[0]->numero_familias_assentadas; ?>">
                            <label class="control-label form" for="movimento_num_familia"></label>
                        </div>
                    </div>
                </div>
