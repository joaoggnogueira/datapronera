...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery.dataTables.bootstrap.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>js/table.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>js/maskedInput.js"></script>
