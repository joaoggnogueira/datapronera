<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = new Table({
            url      : "<?php echo site_url('request/get_producao8c'); ?>",
            table    : $('#paper_table'),
        ...
        oTable = $('#producao_table').dataTable( {
                ...
                "sAjaxSource": url  + "/request/get_producao8c/"
            } );
        ...
        //TABLE CONTROLS
            ...
            $('#inserir').click(function () {
                ...
                var urlRequest = "<?php echo site_url('producao8c/index_add'); ?>";
            ...
            $('#alterar').click(function () { 
                ...
                var formData = {
                   id_producao8c :  codigo,
                   operacao : 'update'
                };

                var urlRequest = "<?php echo site_url('producao8c/index_update'); ?>";
            ...
            $('#remover').click(function () {  
                ...
                $('#dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('producao8c/remove/'); ?>";
