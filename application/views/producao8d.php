<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = new Table({
            url      : "<?php echo site_url('request/get_producao8d'); ?>",
            table    : $('#paper_table'),
        ...
        oTable = $('#producao_table').dataTable( {
                ...
                "sAjaxSource": url  + "/request/get_producao8d/"
            } );
        ...
        //TABLE CONTROLS
            ...
            $('#inserir').click(function () {
                ...
                var urlRequest = "<?php echo site_url('producao8d/index_add'); ?>";
            ...
            $('#alterar').click(function () { 
                ...
                var formData = {
                   id_producao8d :  codigo,
                   operacao : 'update'
                };

                var urlRequest = "<?php echo site_url('producao8d/index_update'); ?>";
            ...
            $('#remover').click(function () {  
                ...
                $('#dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('producao8d/remove/'); ?>";
