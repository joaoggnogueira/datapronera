<script type="text/javascript">    
    ...
    $(document).ready(function() {
        ...
        var tableRunning = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_academico/AN'); ?>",
            table    : $('#running-table'),
        ...
        //TABLE CONTROLS
            ...
            $('#running-add').click(function () {
                ...
                var urlRequest = "<?php echo site_url('producao9a/index_add'); ?>";
            ...
            $('#running-update').click(function () { 
                ...
                var formData = {
                   id_producao9a :  codigo,
                   operacao : 'update'
                };

                var urlRequest = "<?php echo site_url('producao9a/index_update'); ?>";
            ...
            $('#running-delete').click(function () {  
                ...
                $('#running-dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('producao9a/remove/'); ?>";
        ...
        var tableIIPnera = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_academico/2P'); ?>",
