<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var tableRunning = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_video/AN'); ?>",
            table    : $('#running-table'),
        ...
        //TABLE CONTROLS
            ...
            $('#running-add').click(function () {
                ...
                var urlRequest = "<?php echo site_url('producao9e/index_add'); ?>";
            ...
            $('#running-update').click(function () { 
                ...
                var formData = {
                   id_producao9e :  codigo,
                   operacao : 'update'
                };

                var urlRequest = "<?php echo site_url('producao9e/index_update'); ?>";
            ...
            $('#running-delete').click(function () {  
                ...
                $('#running-dialog').dialogInit(function () {
                    ...
                    var urlRequest = "<?php echo site_url('producao9e/remove/'); ?>";
        ...
        var tableIIPnera = new Table({
            url      : "<?php echo site_url('request/get_pesquisa_video/2P'); ?>",
...
<h4>V&iacute;deo / Document&aacute;rio</h4>
