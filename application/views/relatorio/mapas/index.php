...
<div class="panel panel-default" style="margin-bottom: 0px">
    <div class="panel-heading" style="height: 50px !important;">
        ...
        <div style="text-align: right;" class="col-md-5">
            <span class="btn btn-primary" id="loadingmarkers"><div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div></span>
...
<script>
    ...
    function date_to_number(value, nullvalue) {
        var string;
        if (value && value != "###" && value != "" && value != false && value != undefined) {
            string = value;
        } else {
            string = nullvalue;
        }
    ...
    function vigencia_filter(curso) {
        var ini = date_to_number(curso.inicio, "01/1950");
        var fim = date_to_number(curso.termino, "12/2028");
        ...
        var checked_an = document.getElementById("vigencia_an").checked;
        var checked_cc = document.getElementById("vigencia_cc").checked;
